...
immediate_opcodes = {
    '69': Instr(method=Immediate.imd_adc, bytes=2, cycles=2),           #ADC
    '29': Instr(method=Immediate.imd_and, bytes=2, cycles=2),           #AND
    'C9': Instr(method=Immediate.imd_cmp, bytes=2, cycles=2),           #CMP
    'E0': Instr(method=Immediate.imd_cpx, bytes=2, cycles=2),           #CPX
    'C0': Instr(method=Immediate.imd_cpy, bytes=2, cycles=2),           #CPY
    '49': Instr(method=Immediate.imd_eor, bytes=2, cycles=2),           #EOR
    'A9': Instr(method=Immediate.imd_lda, bytes=2, cycles=2),           #LDA
    'A2': Instr(method=Immediate.imd_ldx, bytes=2, cycles=2),           #LDX
    'A0': Instr(method=Immediate.imd_ldy, bytes=2, cycles=2),           #LDY
    '09': Instr(method=Immediate.imd_ora, bytes=2, cycles=2),           #ORA
    'E9': Instr(method=Immediate.imd_sbc, bytes=2, cycles=2)            #SBC
}
...
implied_opcodes = {
    '00': Instr(method=Implied.imp_brk, bytes=1, cycles=7),         #BRK
    'EA': Instr(method=Implied.imp_nop, bytes=1, cycles=2),         #NOP
    '40': Instr(method=Implied.imp_rti, bytes=1, cycles=6),         #RTI
    '60': Instr(method=Implied.imp_rts, bytes=1, cycles=6),         #RTS

    '18': Instr(method=Implied.imp_clc, bytes=1, cycles=2),         #CLC
    '38': Instr(method=Implied.imp_sec, bytes=1, cycles=2),         #SEC
    '58': Instr(method=Implied.imp_cli, bytes=1, cycles=2),         #CLI
    '78': Instr(method=Implied.imp_sei, bytes=1, cycles=2),         #SEI
    'B8': Instr(method=Implied.imp_clv, bytes=1, cycles=2),         #CLV
    'D8': Instr(method=Implied.imp_cld, bytes=1, cycles=2),         #CLD
    'F8': Instr(method=Implied.imp_sed, bytes=1, cycles=2),         #SED

    '9A': Instr(method=Implied.imp_txs, bytes=1, cycles=2),         #TXS
    'BA': Instr(method=Implied.imp_tsx, bytes=1, cycles=2),         #TSX
    '48': Instr(method=Implied.imp_pha, bytes=1, cycles=3),         #PHA
    '68': Instr(method=Implied.imp_pla, bytes=1, cycles=4),         #PLA
    '08': Instr(method=Implied.imp_php, bytes=1, cycles=3),         #PHP
    '28': Instr(method=Implied.imp_plp, bytes=1, cycles=4),         #PLP

    'AA': Instr(method=Implied.imp_tax, bytes=1, cycles=2),         #TAX
    '8A': Instr(method=Implied.imp_txa, bytes=1, cycles=2),         #TXA
    'CA': Instr(method=Implied.imp_dex, bytes=1, cycles=2),         #DEX
    'E8': Instr(method=Implied.imp_inx, bytes=1, cycles=2),         #INX
    'A8': Instr(method=Implied.imp_tay, bytes=1, cycles=2),         #TAY
    '98': Instr(method=Implied.imp_tya, bytes=1, cycles=2),         #TYA
    '88': Instr(method=Implied.imp_dey, bytes=1, cycles=2),         #DEY
    'C8': Instr(method=Implied.imp_iny, bytes=1, cycles=2)          #INY
}
